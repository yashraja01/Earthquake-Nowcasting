...
# Define magnitude bins (from 4.0 up to maximum magnitude, step 0.1)
m_min = 4.0
...
print(f"Gutenberg-Richter fit: log10(N) = {a_value:.3f} - {b_value:.3f} * M")
...
plt.ylabel("log10(N)")
plt.title("Frequency-Magnitude Distribution (Gutenberg–Richter)")
plt.grid(True)
plt.legend()
plt.show()
